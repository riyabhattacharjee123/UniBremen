...
run('D:\MSc. Project Zarm\Sample_s_function\solution_20_May\init_start.m');
...
% Calculate the coordinates for satellite position and receiver antenna
% position in ECI
run('D:\MSc. Project Zarm\Sample_s_function\solution_20_May\coordinates_convertor.m');
run('D:\MSc. Project Zarm\Sample_s_function\solution_20_May\channel_matrix_H.m');