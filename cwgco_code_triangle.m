...
beta = 0.463646716 ; % radians , 26.565 degrees
...
z_0 = c3 * sin(n*t + beta ) ; % metres in LVLH-z
...
ydot_0 = -2 * n * x_0 ; %metres/second this condition avoids drift
ydot_c = ydot_leader + ydot_0 + ydot_rotation ; % metres/second in ECI-y
disp('ydot_c');
disp(ydot_c);

%zdot_0 = c2 * n * cos(alpha); % metres/second in LVLH-z
zdot_0 = c3 * n * cos(beta); % metres/second in LVLH-z
%zdot_0 = 2 * xdot_0; %metres/second this condition avoids drift
