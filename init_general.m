...
% start model
sim('model_idealacc_2018b.slx')% this refers to the model without perturbations
...
% start model
% ( Perturbations added )
sim('model_plusacc_2018b.slx') % this refers to the model with added perturbations
...
for s=1:(length(r_start)/3)
    ...
    title(sprintf('Difference in Ideal and Perturbed orbit Position in ECI-x: satellite- %d',s))
    ...
    title(sprintf('Difference in Ideal and Perturbed orbit Position in ECI-y: satellite- %d',s))
    ...
    title(sprintf('Difference in Ideal and Perturbed orbit Position in ECI-z: satellite- %d',s))
    ...
    plot(ts_pos_diff_x)    
    set(gca,'FontSize',15);
    title(sprintf('Position difference: ECI-x: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-x (metres)')
    ...
    plot(ts_pos_diff_y)   
    set(gca,'FontSize',15);
    title(sprintf('Position difference: ECI-y: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-y (metres)')
    legend('position difference');        
    ...
    plot(ts_pos_diff_z)   
    set(gca,'FontSize',15);
    title(sprintf('Position difference: ECI-z: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-z (metres)')
    legend('position difference'); 
...
for s=1:(length(r_start)/3)
    ...
    title(sprintf('Difference in Ideal and Perturbed orbit Velocity in ECI-x: satellite- %d',s))
    ...
    title(sprintf('Difference in Ideal and Perturbed orbit Velocity in ECI-y: satellite- %d',s))
    ...
    title(sprintf('Difference in Ideal and Perturbed orbit Velocity in ECI-z: satellite- %d',s))
    ...
    plot(ts_vel_diff_x)   
    set(gca,'FontSize',15);
    title(sprintf('Velocity difference: ECI-x: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-x (m/s)')
    ...
    plot(ts_vel_diff_y)    
    set(gca,'FontSize',15);
    title(sprintf('Velocity difference: ECI-y: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-y (m/s)')
    legend('velocity difference');
    ...
    plot(ts_vel_diff_z)  
    set(gca,'FontSize',15);
    title(sprintf('Velocity difference: ECI-z: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-z (m/s)')
    legend('velocity difference'); 
...
for s=1:(length(r_start)/3)
    ...
    title(sprintf('Ideal and Perturbed orbit Acceleration in ECI-x: satellite- %d',s))
    ...
    title(sprintf('Ideal and Perturbed orbit Acceleration in ECI-y: satellite- %d',s))
    ...
    title(sprintf('Ideal and Perturbed orbit Acceleration in ECI-z: satellite- %d',s))
    ...
    plot(ts_acc_diff_x)  
    set(gca,'FontSize',15);
    title(sprintf('Acceleration difference: ECI-x: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-x (m/s^2)')
    ...
    plot(ts_acc_diff_y)   
    set(gca,'FontSize',15);
    title(sprintf('Acceleration difference: ECI-y: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-y (m/s^2)')
    legend('acceleration difference');    
    ...
    plot(ts_acc_diff_z) 
    set(gca,'FontSize',15);
    title(sprintf('Acceleration difference: ECI-z: satellite- %d',s))
    xlabel('Time(seconds)'), ylabel('ECI-z (m/s^2)')
    legend('acceleration difference');
    ...
    % Magnitude of Unperturbed Acceleration
     ...
     plot(acc_pert_mag);
     set(gca,'FontSize',15);
     title(sprintf('Magnitude of the Acceleration Vector for Satellite-%d',s));
